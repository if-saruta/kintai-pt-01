...
class Employee extends Model
{
    ...
    protected $fillable = ['company_name','register_number', 'name', 'initials', 'post_code', 'address', 'building_name', 'phone_number', 'employment_status', 'company_id', 'is_invoice', 'vehicle_rental_type', 'vehicle_id', 'remarks', 'transfer_fee'];
