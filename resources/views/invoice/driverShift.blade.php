    ...
    <main class="main --shift-main">
        ...
        <div class="main__white-board --invoice-white-board">
                        ...
                        <div class="allowance-modal-wrap__modal">
                            <div class="allowance-modal-wrap__modal__inner">
                                ...
                                <div class="input-area">
                                    ...
                                    <input type="text" id="allowanceInput" class="input-area__input input radioRalation"
                                        placeholder="金額を入力">
                                </div>
                            ...
                            <div class="vehicle-modal-wrap__modal__inner">
                                ...
                                <div class="input-area">
                                    ...
                                    <input type="text" id="vehicleInput"
                                        class="input-area__input input vehicleRadioRalation" placeholder="金額を入力">
                                </div>
                            ...
                            <form action="{{route('invoice.driverShiftUpdate')}}" method="POST">
                                ...
                                <div class="driver-shift">
                                    ...
                                    <div class="driver-shift__head">
                                        ...
                                        <div class="driver-shift__head__item --common allowanceRow">
                                            <p class="">手当</p>
                                        </div>
                                    ...
                                    <div class="flex">
                                        <div class="driver-shift__calender-shift">
                                            ...
                                            @if($date->format('d') < 16) <div class="driver-shift__calender-shift__day">
                                                {{-- 日付 --}}
                                                ...
                                                <div class="driver-shift__calender-shift__day__info">
                                                    ...
                                                    <div class="driver-shift__calender-shift__day__info__row">
                                                        {{-- 案件表示 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --project">
                                                            @if ($spv->project)
                                                            ...
                                                            <p style="color:red;" class="--project-name">
                                                        ...
                                                        {{-- 給与 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common amountRow">
                                                        ...
                                                        {{-- 手当 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common allowance-area allowanceRow">
                                                            <input type="text" name="allowance[{{$spv->id}}]"
                                                                value="{{$spv->total_allowance}}"
                                                        ...
                                                        {{-- 高速代 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common expresswayRow">
                                                        ...
                                                        {{-- パーキング --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common parkingRow">
                                                        ...
                                                        {{-- 2台目 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common vehicleRow">
                                                            @if ($spv->vehicle_rental_type != null) {{-- 車両形態が登録されいるか
                                                            --}}
                                                            @if ($spv->vehicle_rental_type == 0 ||
                                                            $spv->vehicle_rental_type == 1) {{-- 自車か月リースなのか --}}
                                                            ...
                                                            <input type="text" class="mainVehicle"
                                                                name="vehicle[{{$spv->id}}]"
                                                                value="{{$spv->vehicle->number}}" readonly>
                                                            @endif
                                                            @endif
                                                            @else {{-- 未登録車両 --}}
                                                            <input type="text" class="mainVehicle"
                                                                name="vehicle[{{$spv->id}}]"
                                                                value="{{$spv->unregistered_vehicle}}" readonly
                                                                style="color:red;">
                                                            @endif
                                                            @endif
                                                            @else {{-- 未登録従業員の車両 --}}
                                                            ...
                                                            if(!in_array($spv->vehicle->number,
                                                            $secound_vehicle_array)){
                                                        ...
                                                        {{-- 残業代 --}}
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common overtimeRow">
                                                            <input type="text" name="overtime_fee[{{$spv->id}}]"
                                                                value="{{$spv->overtime_fee}}">
                                                    ...
                                                    @for ($i = 0; $i < ($mustCnt - $count); $i++) <div
                                                        class="driver-shift__calender-shift__day__info__row">
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --project">
                                                        ...
                                                        <div
                                                            class="driver-shift__calender-shift__day__info__row__data --common allowanceRow">
                                ...
                                <div class="driver-shift__calender-shift__day__info">
                                    ...
                                    <div class="driver-shift__calender-shift__day__info__row">
                                        ...
                                        <div class="driver-shift__calender-shift__day__info__row__data --project">
                                            ...
                                            @endif
                                            @elseif(!empty($spv->unregistered_project))
                                            <p style="color:red;" class="--project-name">{{$spv->unregistered_project}}
                                            </p>
                                            @if (isset($projectCount[$spv->unregistered_project][$spv->retail_price]))
                                            <?php $projectCount[$spv->unregistered_project][$spv->retail_price]++; ?>
                                            @else
                                        ...
                                        <div
                                            class="driver-shift__calender-shift__day__info__row__data --common allowance-area allowanceRow">
                                            <input type="text" name="allowance[{{$spv->id}}]"
                                                value="{{$spv->total_allowance}}" class="allowance-input">
                                            <?php $total_allowance += $spv->total_allowance?>
                                            @if ($spv->project)
                                            @foreach ($allowanceProject as $value)
                                            @if ($value->project_id == $spv->project->id)
                                        ...
                                        <div
                                            ...
                                            @if ($spv->vehicle->number !== '自車')
                                            @if($spv->vehicle_id != $spv->rental_vehicle_id)
                                            <input type="text" class="mainVehicle" name="vehicle[{{$spv->id}}]"
                                                value="{{$spv->vehicle->number}}" readonly>
                                            @endif
                                            @endif
                                            @else {{-- 未登録車両 --}}
                                            <input type="text" class="mainVehicle" name="vehicle[{{$spv->id}}]"
                                                value="{{$spv->unregistered_vehicle}}" readonly style="color:red;">
                                            @endif
                                            @endif
                                            @else {{-- 未登録従業員の車両 --}}
                                            @if ($spv->vehicle_id)
                    ...
                    <div class="column">
                        <div class="total-project-table">
                            <div class="total-project-table__head">
                                <div class="total-project-table__head__item --project">
                                    <p class="">案件名</p>
                                </div>
                                <div class="total-project-table__head__item --common">
                                    <p class="">金額</p>
                                </div>
                                <div class="total-project-table__head__item --common">
                                    <p class="">件数</p>
                            ...
                            <div class="total-project-table__row">
                                <div class="total-project-table__row__item --project">
                                    <p>{{$projectName}}</p>
                                </div>
                                <div class="total-project-table__row__item --common">
                                    <p>{{$amount}}</p>
                                </div>
                                <div class="total-project-table__row__item --common">
                                    <p>{{$count}}</p>
                            ...
                            <div class="total-project-table__row">
                                ...
                                <div class="total-project-table__row__item --common --total-count">
                                    <p>{{$total_project_count}}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="total-amount-table">
                <div class="total-amount-table__row amountRow">
                    <div class="total-amount-table__row__item">
                        <p class="">合計金額</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                ...
                <div class="total-amount-table__row overtimeRow">
                    ...
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$total_overtime}}</p>
                    </div>
                </div>
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">事務委託手数料(15%)</p>
                    </div>
                    <?php $administrative_commission_fee = $total_salary * $administrative_rate?>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{ceil($administrative_commission_fee)}}</p>
                    </div>
                </div>
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                ...
                <div class="total-amount-table__row">
                    ...
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$transfer_fee}}</p>
                    </div>
                </div>
                @if ($vehicle_rental_type == 1 || $vehicle_rental_type == 2)
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">リース代　月契約 No.{{$rental_vehicle_number}}</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$month_lease_fee}}</p>
                    </div>
                </div>
                @php
                ...
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">リース　2台目(日割り)</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$second_lease * $vehicle_second_count}}</p>
                    </div>
                </div>
                @php
                ...
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">リース　3台目(日割り)</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$three_lease * $third_machine_count}}</p>
                    </div>
                </div>
                @php
                ...
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">保険料　月契約 No.{{$rental_vehicle_number}}</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$lease_insurance}}</p>
                    </div>
                </div>
                @php
                ...
                <div class="total-amount-table__row">
                    <div class="total-amount-table__row__item">
                        <p class="">保険料　2台目(日割り)</p>
                    </div>
                    <div class="total-amount-table__row__item --amount">
                        <p class="">{{$daily_insurance_rate * ($vehicle_second_count + $third_machine_count)}}</p>
                    </div>
                </div>
                @php
        ...
        <div class="ab-elem">
            <form action="{{route('invoice.driver-edit-pdf')}}" method="POST">
                @csrf
                {{-- 業務委託手数料 --}}
                <input hidden type="text" name="administrative_commission_fee"
                    value="{{$administrative_commission_fee}}">
                {{-- 合計リース代 --}}
                ...
                <div class="ab-check-area">
                    <div class="item-check-wrap">
                        ...
                        <div class="item-check-wrap__block">
                            <input checked type="checkbox" name="" value="1" id="allowanceCheck">
                            <label for="">手当</label>
                        </div>
                        <div class="item-check-wrap__block">
