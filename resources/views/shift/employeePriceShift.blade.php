            ...
            <div class="shift-calendar">
                ...
                <div class="shift-calendar__date">
                    ...
                    <div class="shift-calendar__date__show">
                        <p class="week-of-month">{{$monday->format('Y')}}年{{$monday->format('n')}}月第{{ $weekOfMonth }}週目 ドライバー価格</p>
                    </div>
                    <form action="{{route('shift.employeePriceShiftSelectWeek')}}" method="POST">
                        @csrf
                ...
                {{-- カレンダー検索 --}}
                <form action="{{route('shift.employeePriceShiftSelectWeek')}}" class="datepicker" method="POST">
                    @csrf
                    <div class="date01">
                            ...
                            @foreach ( $shiftDataByEmployee as $employeeId => $shiftData )
                                ...
                                @if ($hasShift)
                                    <tr class="shift-calendar-table__body__row getRow">
                                        ...
                                        @endforeach
                                        <td class="total-salary">¥{{number_format($weekly_total_salary)}}</td>
                                    </tr>
                                @endif
                                @endforeach
